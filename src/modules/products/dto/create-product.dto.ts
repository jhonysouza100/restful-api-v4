...
class ProductSpecificationsInterface {
  @ApiProperty({
    example: 'Conectividad',
    description: 'Etiqueta de la especificación del producto',
  })
  label: string;
...
class ProductDimensionsInterface {
  @ApiProperty({
    example: 500,
    description: 'Peso del producto en centimetros',
  })
  weight: number;

  @ApiProperty({
    example: 10,
    description: 'Altura del producto en centimetros',
  })
  height: number;

  @ApiProperty({
    example: 20,
    description: 'Ancho del producto en centimetros',
  })
  width: number;
...
export class CreateProductDto {
  ...
  @ApiProperty({
    example: 'Articulo Varios',
    description: 'Nombre del producto para ventas secretas',
  })
  alias?: string;
  ...
  @ApiProperty({
    example: ProductCategoryEnum.OTHER,
  ...
  @ApiProperty({
    example: {
      public_id: 'imagen123',
      secure_url: 'https://example.com/imagen.jpg',
    },
  ...
  @ApiProperty({
    isArray: true,
    example: [
      { public_id: 'imagen123', secure_url: 'https://example.com/imagen.jpg' },
    ],
  ...
  @ApiProperty({
    example: 50,
    description: 'Cantidad máxima de productos que un cliente puede comprar',
    default: 1,
  })
  maxCount?: number;
  ...
  @ApiProperty({
    example: 1,
    description: 'Cantidad mínima de productos que un cliente puede comprar',
    default: 1,
  })
  minCount?: number;
