...
export class ShipmentsController {
  ...
  @ApiOperation({
    summary: 'Obtener tarifas de MiCorreo',
    description: 'Calcula las tarifas de envío disponibles para un paquete.',
  })
  ...
  @ApiOperation({
    summary: 'Importar envío de MiCorreo',
    description: 'Importa un envío en MiCorreo con los datos proporcionados.',
  })
  ...
  @ApiParam({
    name: 'provinceCode',
    description: 'Parametros para búscar sucursales de Correo Argentino',
  })
  @ApiOperation({
    summary: 'Obtener sucursales de Correo Argentino',
    description: 'Devuelve las sucursales de una provincia determinada.',
  })
