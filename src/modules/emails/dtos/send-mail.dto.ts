...
class EmailAttachmentsDto {
  @ApiProperty({
    description:
      'El nombre que va a tomar el archivo, si se establece el valor como false, el nombre del archivo se gerera áutomaticamente',
    example: 'file.pdf',
  })
  filename: string;
  ...
  @ApiProperty({
    description:
      'Tipo de contenido del campo (opcional) para el archivo adjunto, si no configura, se derivará de la propriedad del nombre del archivo',
...
export class SendEmailDto {
  ...
  @ApiProperty({
    description:
      'Lista de destinatarios con sus correos electrónicos y nombres',
