...
export class PaymentsService {
  async createMercadopagoPreference(
    data: CreateMercadopagoPreferenceDto,
    ...
    const createMercadopagoPreferencePayload: CreateMercadopagoPreferenceInterface =
      {
        ...
        payment_methods: {
          ...
          excluded_payment_methods:
            data.payment_methods?.excluded_payment_methods,
          installments: data.payment_methods?.installments,
          default_payment_method_id:
            data.payment_methods?.default_payment_method_id,
        },
      };
  ...
  async getMercadopagoPaymentById(data: {
    id?: string;
