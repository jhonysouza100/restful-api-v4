...
2. `confirmMercadopagoPayment` recibe la notificación y puede:
	...
	- Tipar la respuesta del GET con `MercadopagoPreferenceCreatedPayload`.
...
- `MercadopagoWebhookPayload` / `MercadopagoPreferenceCreatedPayload` — payload del webhook y detalle del pago cuando se obtiene por GET.
